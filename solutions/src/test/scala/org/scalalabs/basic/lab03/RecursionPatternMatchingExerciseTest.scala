...
import org.scalalabs.basic.lab03.RecursionPatternMatchingExercise._
...
class RecursionPatternMatchingExerciseTest extends Specification {
  ...
  "RecursionPatternMatchingExercise" should {
    ...
    "group consecutive members" in {
      List(List(1, 1, 1), List(5), List(4, 4), List(1, 1)) === groupConsecutive(
        List(1, 1, 1, 5, 4, 4, 1, 1))
    }
    "group equal members" in {
      List(List(1, 1, 1, 1), List(5, 5), List(4, 4)) === groupEquals(
    ...
    "define amount equal members" in {
      List((4, "x"), (2, "y"), (2, "z")) === amountEqualMembers(
        List("x", "x", "x", "y", "z", "z", "y", "x"))
      List((4, "Cow"), (2, "Boy"), (1, "Hut")) === amountEqualMembers(
