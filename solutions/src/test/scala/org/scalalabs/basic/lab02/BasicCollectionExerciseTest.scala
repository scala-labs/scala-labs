...
import org.scalalabs.basic.lab02.BasicCollectionExercise02.Person
/**
...
class BasicCollectionExerciseTest extends Specification {
  ...
  "BasicCollectionExercise01: GoogleCodeJam" should {
    "get first Element in list" in {
      ...
      val result = BasicCollectionExercise01.googleCodeJamGooglerese(in1, in2, in3)
      Seq(out1, out2, out3) === result
    }
  }

  "BasicCollectionExercise02" should {
    "group a list of adults by age group. Each group is sorted by name" in {
      ...
      val result = BasicCollectionExercise02.groupAdultsPerAgeGroup(Seq(jack, duke, jeniffer, erik, susy))
      Map(20 -> Seq(erik), 30 -> Seq(duke, jeniffer), 40 -> Seq(susy)) ==== result
    }
  }

  "BasicCollectionExercise03" should {
    "calculate the length of the longest word in a list of sentences" in {
      ...
      val result = BasicCollectionExercise03.calcLengthLongestWord(l1, l2)
