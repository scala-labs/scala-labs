...
/** We could have used a simple String as the symbol type in the Currency class. However, a ADT (Algebraic Data Type)
  * helps narrow our domain. The domain of a String is infinite, as it can be an empty string (""), a number ("1") and
  * even contain the works of Shakespeare. Narrowing the domain makes it possible for the compiler to help you out.
  */
object Symbol {
