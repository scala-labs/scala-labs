  ...
  "RecursionPatternMatchingExercise" should {
    ...
    "group consecutive members" in {
      List(
        ...
        List(4, 4),
        List(1, 1)
      ) === RecursionPatternMatchingExercise.groupConsecutive(
    ...
    "group equal members" in {
      List(
        ...
        List(5, 5),
        List(4, 4)
      ) === RecursionPatternMatchingExercise.groupEquals(
    ...
    "define amount equal members" in {
      ...
      List(
        ...
        (2, "Boy"),
        (1, "Hut")
      ) === RecursionPatternMatchingExercise.amountEqualMembers(
    ...
    "zip multiple" in {
      List(
        ...
        List(2, "B", "b"),
        List(3, "C", "c")
      ) === RecursionPatternMatchingExercise.zipMultiple(
