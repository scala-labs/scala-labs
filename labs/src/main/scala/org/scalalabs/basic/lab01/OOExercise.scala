...
/** The goal of this exercise is to get familiar basic OO constructs in scala
  ...
  *   - Provide an immutable field named: inCents that converts euro + cents
  *     into cents.
  *   - Create an object Euro with a factory method named: fromCents that
  *     creates an Euro based on cents.
  ...
  *   - In case the cents are 0 use this representation: -> symbol + ': ' + euro
  *     + ',--. E.g.: EUR 200.--
  *
  * Exercise 3:
  ...
  *   - Provide a implicit conversion method that converts from Dollar to Euro
  *     using the [[org.scalalabs.basic.lab01.DefaultCurrencyConverter]]
  *
  * Exercise 5:
  *   - Extend the conversion method from Dollar to Euro with an implicit
  *     parameter of type [[org.scalalabs.basic.lab01.CurrencyConverter]]
  *   - Use the implicit CurrencyConverter to do the conversion.
  *
  * Note: For Exercise 4 and 5 you will need different versions of the
  * conversion method. It's okay if you can pass only either 4 or 5 at a time.
  */
class Euro {}
