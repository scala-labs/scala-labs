...
object PatternMatchingExercise {
  ...
  /** Use the FileName object to write a simple argument extractor, which
    * extracts filename and extension. Basically, implement an apply and unapply
    * method. Example: MyNotes.txt -> MyNotes txt
    */
  object FileName {
  ...
  /** Use the Path object to write a variable argument extractor, which extracts
    * the elements of a path in reverse order. Basically implement an unapplySeq
    * method Example: /home/anyuser/development/scala/ -> scala development
    * anyuser home
    */
  object Path {
